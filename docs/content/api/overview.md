...
- [API 基础信息](#api-基础信息) `:36+7`
- [Swagger 文档](#swagger-文档) `:43+7`
- [认证方式](#认证方式) `:50+35`
  - [JWT Token](#jwt-token) `:52+16`
  - [Personal Access Token (PAT)](#personal-access-token-pat) `:68+17`
- [响应格式](#响应格式) `:85+45`
  - [成功响应](#成功响应) `:87+13`
  - [错误响应](#错误响应) `:100+14`
  - [分页响应](#分页响应) `:114+16`
- [HTTP 状态码](#http-状态码) `:130+16`
- [API 模块](#api-模块) `:146+39`
  - [认证管理 (/api/auth)](#认证管理-apiauth) `:148+7`
  - [用户管理 (/api/users)](#用户管理-apiusers) `:155+6`
  - [角色管理 (/api/roles)](#角色管理-apiroles) `:161+6`
  - [菜单管理 (/api/menus)](#菜单管理-apimenus) `:167+6`
  - [PAT 管理 (/api/pat)](#pat-管理-apipat) `:173+6`
  - [审计日志 (/api/audit-logs)](#审计日志-apiaudit-logs) `:179+6`
- [请求示例](#请求示例) `:185+55`
  - [基础认证流程](#基础认证流程) `:187+27`
  - [创建资源](#创建资源) `:214+14`
  - [查询资源](#查询资源) `:228+12`
- [公共参数](#公共参数) `:240+19`
  - [分页参数](#分页参数) `:242+8`
