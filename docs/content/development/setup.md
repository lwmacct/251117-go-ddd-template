...
- [系统要求](#系统要求) `:40+16`
  ...
  - [推荐软件](#推荐软件) `:49+7`
- [环境准备](#环境准备) `:56+47`
  - [1. 安装 Go](#1-安装-go) `:58+14`
  - [2. 安装 Docker](#2-安装-docker) `:72+15`
  - [3. 安装开发工具](#3-安装开发工具) `:87+16`
- [项目设置](#项目设置) `:103+72`
  - [1. 克隆代码](#1-克隆代码) `:105+7`
  - [2. 安装依赖](#2-安装依赖) `:112+13`
  - [3. 环境配置](#3-环境配置) `:125+30`
  - [4. 启动基础服务](#4-启动基础服务) `:155+10`
  - [5. 初始化数据库](#5-初始化数据库) `:165+10`
- [IDE 配置](#ide-配置) `:175+37`
  - [VSCode](#vscode) `:177+28`
  - [GoLand](#goland) `:205+7`
- [开发工作流](#开发工作流) `:212+60`
  - [1. 启动开发服务器](#1-启动开发服务器) `:214+13`
  - [2. 前端开发](#2-前端开发) `:227+8`
  - [3. 文档开发](#3-文档开发) `:235+8`
  - [4. 运行测试](#4-运行测试) `:243+16`
  - [5. 代码检查](#5-代码检查) `:259+13`
- [常用 Task 命令](#常用-task-命令) `:272+31`
- [调试配置](#调试配置) `:303+39`
  - [使用 Delve](#使用-delve) `:305+13`
  - [VSCode 调试配置](#vscode-调试配置) `:318+24`
- [故障排查](#故障排查) `:342+32`
  - [端口占用](#端口占用) `:344+10`
  - [依赖问题](#依赖问题) `:354+10`
  - [Docker 问题](#docker-问题) `:364+10`
