...
- [系统要求](#系统要求) `:40:41`
  ...
  - [推荐软件](#推荐软件) `:49:55`
- [环境准备](#环境准备) `:56:57`
  - [1. 安装 Go](#1-安装-go) `:58:71`
  - [2. 安装 Docker](#2-安装-docker) `:72:86`
  - [3. 安装开发工具](#3-安装开发工具) `:87:102`
- [项目设置](#项目设置) `:103:104`
  - [1. 克隆代码](#1-克隆代码) `:105:111`
  - [2. 安装依赖](#2-安装依赖) `:112:124`
  - [3. 环境配置](#3-环境配置) `:125:154`
  - [4. 启动基础服务](#4-启动基础服务) `:155:164`
  - [5. 初始化数据库](#5-初始化数据库) `:165:174`
- [IDE 配置](#ide-配置) `:175:176`
  - [VSCode](#vscode) `:177:204`
  - [GoLand](#goland) `:205:211`
- [开发工作流](#开发工作流) `:212:213`
  - [1. 启动开发服务器](#1-启动开发服务器) `:214:226`
  - [2. 前端开发](#2-前端开发) `:227:234`
  - [3. 文档开发](#3-文档开发) `:235:242`
  - [4. 运行测试](#4-运行测试) `:243:258`
  - [5. 代码检查](#5-代码检查) `:259:271`
- [常用 Task 命令](#常用-task-命令) `:272:302`
- [调试配置](#调试配置) `:303:304`
  - [使用 Delve](#使用-delve) `:305:317`
  - [VSCode 调试配置](#vscode-调试配置) `:318:341`
- [故障排查](#故障排查) `:342:343`
  - [端口占用](#端口占用) `:344:353`
  - [依赖问题](#依赖问题) `:354:363`
  - [Docker 问题](#docker-问题) `:364:373`
