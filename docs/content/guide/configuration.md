...
- [环境变量](#环境变量) `:64+22`
- [配置结构](#配置结构) `:86+35`
  - [Server 配置](#server-配置) `:88+9`
  - [Data 配置](#data-配置) `:97+9`
  - [JWT 配置](#jwt-配置) `:106+8`
  - [Log 配置](#log-配置) `:114+7`
- [生产环境配置](#生产环境配置) `:121+35`
  - [使用 Docker](#使用-docker) `:123+9`
  - [使用 Kubernetes](#使用-kubernetes) `:132+14`
  - [使用 Systemd](#使用-systemd) `:146+10`
- [配置验证](#配置验证) `:156+8`
- [动态配置](#动态配置) `:164+8`
- [安全建议](#安全建议) `:172+17`
- [配置最佳实践](#配置最佳实践) `:189+19`
