...
- [目录概览](#目录概览) `:23+24`
- [核心目录详解](#核心目录详解) `:47+128`
  - [internal/ - 业务核心](#internal-业务核心) `:49+56`
  - [web/ - 前端应用](#web-前端应用) `:105+36`
  - [docs/ - 文档系统](#docs-文档系统) `:141+18`
  - [configs/ - 配置文件](#configs-配置文件) `:159+8`
  - [testing/ - 测试脚本](#testing-测试脚本) `:167+8`
- [文件命名规范](#文件命名规范) `:175+27`
  - [Go 文件](#go-文件) `:177+11`
  - [前端文件](#前端文件) `:188+14`
- [构建产物](#构建产物) `:202+12`
- [配置优先级](#配置优先级) `:214+7`
