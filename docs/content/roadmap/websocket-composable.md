...
- [使用方式](#使用方式) `:49+146`
  ...
  - [自动重连](#自动重连) `:72+20`
  - [心跳检测](#心跳检测) `:92+12`
  - [JSON WebSocket](#json-websocket) `:104+25`
  - [二进制 WebSocket](#二进制-websocket) `:129+21`
  - [多连接管理](#多连接管理) `:150+30`
  - [消息缓冲](#消息缓冲) `:180+15`
- [API](#api) `:195+47`
  - [useWebSocket](#usewebsocket) `:197+27`
  - [AutoReconnect 配置](#autoreconnect-配置) `:224+10`
  - [Heartbeat 配置](#heartbeat-配置) `:234+8`
- [代码位置](#代码位置) `:242+7`
