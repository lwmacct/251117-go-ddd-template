...
- [进度概览](#进度概览) `:34+18`
- [阶段 1: 补全 Domain 层错误定义](#阶段-1-补全-domain-层错误定义) `:52+23`
  - [目标](#目标) `:54+4`
  - [涉及模块](#涉及模块) `:58+10`
  - [完成情况](#完成情况) `:68+7`
- [阶段 2: 增强 Role/Permission 领域模型](#阶段-2-增强-rolepermission-领域模型) `:75+29`
  - [目标](#目标-1) `:77+4`
  - [Role 新增方法](#role-新增方法) `:81+14`
  - [Permission 新增方法](#permission-新增方法) `:95+9`
- [阶段 3: 增强 Setting/AuditLog 领域模型](#阶段-3-增强-settingauditlog-领域模型) `:104+29`
  - [Setting 新增方法](#setting-新增方法) `:106+13`
  - [AuditLog 新增方法](#auditlog-新增方法) `:119+14`
- [阶段 4: 增强 Captcha/PAT 领域模型](#阶段-4-增强-captchapat-领域模型) `:133+25`
  - [Captcha 新增方法](#captcha-新增方法) `:135+8`
  - [PAT 新增方法](#pat-新增方法) `:143+15`
- [阶段 5-10: 补充 Handler 测试](#阶段-5-10-补充-handler-测试) `:158+15`
  - [测试覆盖目标](#测试覆盖目标) `:160+13`
- [阶段 11: 修复 Repository 接口一致性](#阶段-11-修复-repository-接口一致性) `:173+10`
  - [待修复项](#待修复项) `:175+8`
- [执行日志](#执行日志) `:183+96`
  - [2025-11-30](#2025-11-30) `:185+94`
- [计划完成总结](#计划完成总结) `:279+7`
