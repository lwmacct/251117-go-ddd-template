...
- [进度概览](#进度概览) `:34:51`
- [阶段 1: 补全 Domain 层错误定义](#阶段-1-补全-domain-层错误定义) `:52:53`
  - [目标](#目标) `:54:57`
  - [涉及模块](#涉及模块) `:58:67`
  - [完成情况](#完成情况) `:68:74`
- [阶段 2: 增强 Role/Permission 领域模型](#阶段-2-增强-rolepermission-领域模型) `:75:76`
  - [目标](#目标-1) `:77:80`
  - [Role 新增方法](#role-新增方法) `:81:94`
  - [Permission 新增方法](#permission-新增方法) `:95:103`
- [阶段 3: 增强 Setting/AuditLog 领域模型](#阶段-3-增强-settingauditlog-领域模型) `:104:105`
  - [Setting 新增方法](#setting-新增方法) `:106:118`
  - [AuditLog 新增方法](#auditlog-新增方法) `:119:132`
- [阶段 4: 增强 Captcha/PAT 领域模型](#阶段-4-增强-captchapat-领域模型) `:133:134`
  - [Captcha 新增方法](#captcha-新增方法) `:135:142`
  - [PAT 新增方法](#pat-新增方法) `:143:157`
- [阶段 5-10: 补充 Handler 测试](#阶段-5-10-补充-handler-测试) `:158:159`
  - [测试覆盖目标](#测试覆盖目标) `:160:172`
- [阶段 11: 修复 Repository 接口一致性](#阶段-11-修复-repository-接口一致性) `:173:174`
  - [待修复项](#待修复项) `:175:182`
- [执行日志](#执行日志) `:183:184`
  - [2025-11-30](#2025-11-30) `:185:186`
- [计划完成总结](#计划完成总结) `:279:285`
