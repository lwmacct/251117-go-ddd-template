...
- [使用方式](#使用方式) `:73+259`
  - [防抖 ref](#防抖-ref) `:75+13`
  - [节流 ref](#节流-ref) `:88+19`
  - [历史记录（撤销/重做）](#历史记录撤销重做) `:107+40`
  - [自动重置](#自动重置) `:147+17`
  - [可控 ref](#可控-ref) `:164+24`
  - [同步 ref](#同步-ref) `:188+20`
  - [模板 ref](#模板-ref) `:208+15`
  - [计数器](#计数器) `:223+21`
  - [布尔开关](#布尔开关) `:244+17`
  - [对象操作](#对象操作) `:261+23`
  - [数组操作](#数组操作) `:284+15`
  - [集合操作](#集合操作) `:299+16`
  - [Map 操作](#map-操作) `:315+17`
- [API](#api) `:332+54`
  - [refDebounced](#refdebounced) `:334+7`
  - [refThrottled](#refthrottled) `:341+8`
  - [refHistory](#refhistory) `:349+22`
  - [useCounter](#usecounter) `:371+15`
- [代码位置](#代码位置) `:386+7`
