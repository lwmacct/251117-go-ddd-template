...
- [使用方式](#使用方式) `:60+153`
  - [基础标题管理](#基础标题管理) `:62+23`
  - [模板标题](#模板标题) `:85+18`
  - [Favicon 管理](#favicon-管理) `:103+16`
  - [文档可见性](#文档可见性) `:119+18`
  - [页面离开检测](#页面离开检测) `:137+17`
  - [Head 管理](#head-管理) `:154+16`
  - [动态脚本加载](#动态脚本加载) `:170+23`
  - [动态样式表加载](#动态样式表加载) `:193+20`
- [API](#api) `:213+55`
  - [useTitle](#usetitle) `:215+13`
  - [useTitleTemplate](#usetitletemplate) `:228+14`
  - [useDocumentVisibility](#usedocumentvisibility) `:242+8`
  - [useScript](#usescript) `:250+18`
- [代码位置](#代码位置) `:268+7`
