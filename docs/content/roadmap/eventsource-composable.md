...
- [使用方式](#使用方式) `:49+117`
  ...
  - [携带凭证](#携带凭证) `:158+8`
- [API](#api) `:166+46`
  - [useEventSource](#useeventsource) `:168+26`
  - [useEventSourceNamed 额外返回值](#useeventsourcenamed-额外返回值) `:194+9`
  - [AutoReconnect 配置](#autoreconnect-配置) `:203+9`
- [SSE vs WebSocket](#sse-vs-websocket) `:212+10`
- [代码位置](#代码位置) `:222+7`
