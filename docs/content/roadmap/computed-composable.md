...
- [已实现功能](#已实现功能) `:40+38`
  ...
  - [其他](#其他) `:71+7`
- [使用方式](#使用方式) `:78+203`
  - [异步 computed](#异步-computed) `:80+29`
  - [防抖 computed](#防抖-computed) `:109+14`
  - [节流 computed](#节流-computed) `:123+15`
  - [可控 computed](#可控-computed) `:138+20`
  - [对象属性选取](#对象属性选取) `:158+21`
  - [从多个源创建](#从多个源创建) `:179+15`
  - [数组操作](#数组操作-1) `:194+30`
  - [带历史记录](#带历史记录) `:224+19`
  - [条件 computed](#条件-computed) `:243+19`
  - [可写 computed](#可写-computed) `:262+19`
- [API](#api) `:281+50`
  - [computedAsync](#computedasync) `:283+17`
  - [computedDebounced](#computeddebounced) `:300+7`
  - [computedThrottled](#computedthrottled) `:307+8`
  - [computedArray](#computedarray) `:315+16`
- [代码位置](#代码位置) `:331+7`
