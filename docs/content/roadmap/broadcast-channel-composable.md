...
- [使用方式](#使用方式) `:42+144`
  - [基础用法](#基础用法) `:44+20`
  - [状态同步](#状态同步) `:64+36`
  - [Leader 选举](#leader-选举) `:100+34`
  - [消息传递](#消息传递) `:134+32`
  - [JSON 格式广播](#json-格式广播) `:166+20`
- [API](#api) `:186+57`
  - [useBroadcastChannel](#usebroadcastchannel) `:188+12`
  - [useTabSync](#usetabsync) `:200+16`
  - [useTabLeader](#usetableader) `:216+16`
  - [useTabMessenger](#usetabmessenger) `:232+11`
- [使用场景](#使用场景) `:243+10`
- [代码位置](#代码位置) `:253+7`
