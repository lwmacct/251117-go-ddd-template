...
- [使用方式](#使用方式) `:59+285`
  ...
  - [打字机效果](#打字机效果) `:308+36`
- [API](#api) `:344+41`
  - [useTransition](#usetransition) `:346+12`
  - [useSlide](#useslide) `:358+9`
  - [useAnimation](#useanimation) `:367+11`
  - [useNumberTransition](#usenumbertransition) `:378+7`
- [代码位置](#代码位置) `:385+7`
