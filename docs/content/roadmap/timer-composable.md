...
- [使用方式](#使用方式) `:67+112`
  ...
  - [间隔定时器](#间隔定时器-1) `:88+20`
  - [实时时间](#实时时间) `:108+11`
  - [requestAnimationFrame](#requestanimationframe) `:119+12`
  - [日期格式化](#日期格式化-1) `:131+16`
  - [任务调度器](#任务调度器) `:147+18`
  - [空闲回调](#空闲回调) `:165+14`
- [API](#api) `:179+34`
  - [useTimeout](#usetimeout) `:181+9`
  - [useInterval](#useinterval) `:190+10`
  - [useScheduler](#usescheduler) `:200+13`
- [代码位置](#代码位置) `:213+7`
