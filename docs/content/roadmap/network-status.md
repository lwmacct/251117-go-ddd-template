...
- [需求背景](#需求背景) `:26+4`
- [已实现功能](#已实现功能) `:30+25`
  - [useNetwork](#usenetwork) `:32+8`
  - [useOnline](#useonline) `:40+5`
  - [useNetworkSpeed](#usenetworkspeed) `:45+5`
  - [useNetworkBanner](#usenetworkbanner) `:50+5`
- [使用方式](#使用方式) `:55+54`
  - [基础用法](#基础用法) `:57+15`
  - [简化用法](#简化用法) `:72+11`
  - [网络速度测试](#网络速度测试) `:83+12`
  - [网络状态提示](#网络状态提示) `:95+14`
- [API](#api) `:109+14`
  - [useNetwork 返回值](#usenetwork-返回值) `:111+12`
- [代码位置](#代码位置) `:123+7`
