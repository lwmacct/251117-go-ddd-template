...
- [工具链概览](#工具链概览) `:43+11`
- [ESLint 配置](#eslint-配置) `:54+35`
  - [常用命令](#常用命令) `:79+10`
- [Prettier 配置](#prettier-配置) `:89+27`
  - [常用命令](#常用命令-1) `:106+10`
- [组件编写规范](#组件编写规范) `:116+85`
  - [文件命名](#文件命名) `:118+12`
  - [组件结构](#组件结构) `:130+50`
  - [Props 定义](#props-定义) `:180+21`
- [Composables 规范](#composables-规范) `:201+54`
  - [命名规范](#命名规范) `:203+5`
  - [结构模板](#结构模板) `:208+47`
- [TypeScript 规范](#typescript-规范) `:255+42`
  - [类型定义](#类型定义) `:257+24`
  - [未使用变量](#未使用变量) `:281+16`
- [测试规范](#测试规范) `:297+51`
  - [文件位置](#文件位置) `:299+13`
  - [测试结构](#测试结构) `:312+23`
  - [常用命令](#常用命令-2) `:335+13`
- [Git 提交规范](#git-提交规范) `:348+36`
  - [Commit Message 格式](#commit-message-格式) `:350+10`
  - [类型说明](#类型说明) `:360+12`
  - [示例](#示例) `:372+12`
- [IDE 配置](#ide-配置) `:384+23`
  - [VS Code 推荐扩展](#vs-code-推荐扩展) `:386+7`
  - [推荐设置](#推荐设置) `:393+14`
- [下一步](#下一步) `:407+5`
