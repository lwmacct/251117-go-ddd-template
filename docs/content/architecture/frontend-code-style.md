...
- [工具链概览](#工具链概览) `:45+11`
- [ESLint 配置](#eslint-配置) `:56+35`
  - [常用命令](#常用命令) `:81+10`
- [Prettier 配置](#prettier-配置) `:91+27`
  - [常用命令](#常用命令-1) `:108+10`
- [组件编写规范](#组件编写规范) `:118+85`
  - [文件命名](#文件命名) `:120+12`
  - [组件结构](#组件结构) `:132+50`
  - [Props 定义](#props-定义) `:182+21`
- [Composables 规范](#composables-规范) `:203+54`
  - [命名规范](#命名规范) `:205+5`
  - [结构模板](#结构模板) `:210+47`
- [TypeScript 规范](#typescript-规范) `:257+42`
  - [类型定义](#类型定义) `:259+24`
  - [未使用变量](#未使用变量) `:283+16`
- [测试规范](#测试规范) `:299+51`
  - [文件位置](#文件位置) `:301+13`
  - [测试结构](#测试结构) `:314+23`
  - [常用命令](#常用命令-2) `:337+13`
- [Git 提交规范](#git-提交规范) `:350+36`
  - [Commit Message 格式](#commit-message-格式) `:352+10`
  - [类型说明](#类型说明) `:362+12`
  - [示例](#示例) `:374+12`
- [IDE 配置](#ide-配置) `:386+23`
  - [VS Code 推荐扩展](#vs-code-推荐扩展) `:388+7`
  - [推荐设置](#推荐设置) `:395+14`
- [下一步](#下一步) `:409+5`
