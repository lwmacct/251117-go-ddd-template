...
- [功能特性](#功能特性) `:51+11`
- [快速开始](#快速开始) `:62+60`
  - [1. 启动 Redis 服务](#1-启动-redis-服务) `:64+18`
  - [2. 配置 Redis 连接](#2-配置-redis-连接) `:82+30`
  - [3. 运行应用](#3-运行应用) `:112+10`
- [架构设计](#架构设计) `:122+40`
  - [代码结构](#代码结构) `:124+17`
  - [CacheRepository 接口](#cacherepository-接口) `:141+21`
- [API 端点](#api-端点) `:162+54`
  - [健康检查](#健康检查) `:164+16`
  - [设置缓存](#设置缓存) `:180+12`
  - [获取缓存](#获取缓存) `:192+18`
  - [删除缓存](#删除缓存) `:210+6`
- [使用示例](#使用示例) `:216+137`
  ...
  - [缓存结构体](#缓存结构体) `:257+18`
  - [分布式锁](#分布式锁) `:275+18`
  - [缓存更新模式](#缓存更新模式) `:293+60`
- [常用场景](#常用场景) `:353+133`
  - [1. 会话管理](#1-会话管理) `:355+20`
  - [2. API 限流](#2-api-限流) `:375+32`
  - [3. 防止缓存穿透](#3-防止缓存穿透) `:407+32`
  - [4. 防止缓存雪崩](#4-防止缓存雪崩) `:439+27`
  - [5. 排行榜 (Sorted Set)](#5-排行榜-sorted-set) `:466+20`
- [性能优化](#性能优化) `:486+29`
  - [1. Pipeline (批量操作)](#1-pipeline-批量操作) `:488+14`
  - [2. 连接池配置](#2-连接池配置) `:502+13`
- [故障排查](#故障排查) `:515+50`
  - [连接失败](#连接失败) `:517+19`
  - [性能问题](#性能问题) `:536+16`
  - [键过期问题](#键过期问题) `:552+13`
- [最佳实践](#最佳实践) `:565+27`
- [扩展功能](#扩展功能) `:592+58`
  - [1. Redis Cluster 支持](#1-redis-cluster-支持) `:594+14`
  - [2. Redis 哨兵模式](#2-redis-哨兵模式) `:608+9`
  - [3. 发布/订阅](#3-发布订阅) `:617+17`
  - [4. Lua 脚本](#4-lua-脚本) `:634+16`
- [注意事项](#注意事项) `:650+23`
- [下一步](#下一步) `:673+6`
