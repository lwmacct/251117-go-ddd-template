...
- [功能特性](#功能特性) `:49+11`
- [快速开始](#快速开始) `:60+60`
  - [1. 启动 Redis 服务](#1-启动-redis-服务) `:62+18`
  - [2. 配置 Redis 连接](#2-配置-redis-连接) `:80+30`
  - [3. 运行应用](#3-运行应用) `:110+10`
- [架构设计](#架构设计) `:120+40`
  - [代码结构](#代码结构) `:122+17`
  - [CacheRepository 接口](#cacherepository-接口) `:139+21`
- [API 端点](#api-端点) `:160+54`
  - [健康检查](#健康检查) `:162+16`
  - [设置缓存](#设置缓存) `:178+12`
  - [获取缓存](#获取缓存) `:190+18`
  - [删除缓存](#删除缓存) `:208+6`
- [使用示例](#使用示例) `:214+137`
  ...
  - [缓存结构体](#缓存结构体) `:255+18`
  - [分布式锁](#分布式锁) `:273+18`
  - [缓存更新模式](#缓存更新模式) `:291+60`
- [常用场景](#常用场景) `:351+133`
  - [1. 会话管理](#1-会话管理) `:353+20`
  - [2. API 限流](#2-api-限流) `:373+32`
  - [3. 防止缓存穿透](#3-防止缓存穿透) `:405+32`
  - [4. 防止缓存雪崩](#4-防止缓存雪崩) `:437+27`
  - [5. 排行榜 (Sorted Set)](#5-排行榜-sorted-set) `:464+20`
- [性能优化](#性能优化) `:484+29`
  - [1. Pipeline (批量操作)](#1-pipeline-批量操作) `:486+14`
  - [2. 连接池配置](#2-连接池配置) `:500+13`
- [故障排查](#故障排查) `:513+50`
  - [连接失败](#连接失败) `:515+19`
  - [性能问题](#性能问题) `:534+16`
  - [键过期问题](#键过期问题) `:550+13`
- [最佳实践](#最佳实践) `:563+27`
- [扩展功能](#扩展功能) `:590+58`
  - [1. Redis Cluster 支持](#1-redis-cluster-支持) `:592+14`
  - [2. Redis 哨兵模式](#2-redis-哨兵模式) `:606+9`
  - [3. 发布/订阅](#3-发布订阅) `:615+17`
  - [4. Lua 脚本](#4-lua-脚本) `:632+16`
- [注意事项](#注意事项) `:648+23`
- [下一步](#下一步) `:671+6`
