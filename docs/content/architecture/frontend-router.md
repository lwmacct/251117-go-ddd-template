...
- [路由结构](#路由结构) `:24+10`
- [路由配置](#路由配置-1) `:34+58`
  - [认证路由 (auth.ts)](#认证路由-authts) `:36+21`
  - [管理后台路由 (admin.ts)](#管理后台路由-admints) `:57+19`
  - [用户中心路由 (user.ts)](#用户中心路由-userts) `:76+16`
- [路由守卫](#路由守卫) `:92+30`
- [路由元信息 (Meta)](#路由元信息-meta) `:122+8`
- [路由跳转](#路由跳转) `:130+27`
  - [编程式导航](#编程式导航) `:132+17`
  - [声明式导航](#声明式导航) `:149+8`
- [布局组件](#布局组件) `:157+14`
  - [AdminLayout](#adminlayout) `:159+8`
  - [UserLayout](#userlayout) `:167+4`
- [路由懒加载](#路由懒加载) `:171+10`
