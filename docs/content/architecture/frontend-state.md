...
- [Store 结构](#store-结构) `:25+9`
- [认证 Store](#认证-store) `:34+122`
  - [状态定义](#状态定义) `:38+47`
  - [初始化流程](#初始化流程) `:85+23`
  - [登录流程](#登录流程) `:108+33`
  - [登出流程](#登出流程) `:141+15`
- [在组件中使用](#在组件中使用) `:156+40`
  - [Options API](#options-api) `:158+19`
  - [Composition API](#composition-api) `:177+19`
- [Token 存储](#token-存储) `:196+35`
- [最佳实践](#最佳实践) `:231+25`
  - [1. 状态最小化](#1-状态最小化) `:233+4`
  - [2. 使用 Getters](#2-使用-getters) `:237+4`
  - [3. Action 异步处理](#3-action-异步处理) `:241+4`
  - [4. 错误处理](#4-错误处理) `:245+11`
