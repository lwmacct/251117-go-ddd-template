...
- [文档列表](#文档列表) `:57+20`
  - [核心架构](#核心架构) `:59+6`
  - [数据与基础设施](#数据与基础设施) `:65+5`
  - [身份与访问控制](#身份与访问控制) `:70+7`
- [文档定位](#文档定位) `:77+16`
  - [目标读者](#目标读者) `:79+6`
  - [内容特点](#内容特点) `:85+8`
- [快速导航](#快速导航) `:93+31`
...
- [相关文档](#相关文档) `:124+6`
- [架构亮点](#架构亮点) `:130+73`
  - [1. 三段式细粒度权限](#1-三段式细粒度权限) `:132+16`
  - [2. 双重认证机制](#2-双重认证机制) `:148+13`
  - [3. DDD + CQRS 四层架构](#3-ddd-cqrs-四层架构) `:161+26`
  - [4. 审计日志系统](#4-审计日志系统) `:187+16`
- [技术栈](#技术栈) `:203+16`
  - [后端核心](#后端核心) `:205+9`
  - [数据存储](#数据存储) `:214+5`
- [架构图](#架构图) `:219+67`
