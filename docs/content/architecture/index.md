...
- [文档列表](#文档列表) `:55+20`
  - [核心架构](#核心架构) `:57+6`
  - [数据与基础设施](#数据与基础设施) `:63+5`
  - [身份与访问控制](#身份与访问控制) `:68+7`
- [文档定位](#文档定位) `:75+16`
  - [目标读者](#目标读者) `:77+6`
  - [内容特点](#内容特点) `:83+8`
- [快速导航](#快速导航) `:91+31`
...
- [相关文档](#相关文档) `:122+6`
- [架构亮点](#架构亮点) `:128+73`
  - [1. 三段式细粒度权限](#1-三段式细粒度权限) `:130+16`
  - [2. 双重认证机制](#2-双重认证机制) `:146+13`
  - [3. DDD + CQRS 四层架构](#3-ddd-cqrs-四层架构) `:159+26`
  - [4. 审计日志系统](#4-审计日志系统) `:185+16`
- [技术栈](#技术栈) `:201+16`
  - [后端核心](#后端核心) `:203+9`
  - [数据存储](#数据存储) `:212+5`
- [架构图](#架构图) `:217+67`
