...
func NewOrgMemberCommandRepository(db *gorm.DB) organization.MemberCommandRepository {
	return &orgMemberCommandRepository{db: db}
}

// Add 添加成员到组织
func (r *orgMemberCommandRepository) Add(ctx context.Context, member *organization.Member) error {
...
// UpdateRole 更新成员角色
func (r *orgMemberCommandRepository) UpdateRole(ctx context.Context, orgID, userID uint, role organization.MemberRole) error {
