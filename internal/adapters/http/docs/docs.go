...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SetPermissionsRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/user.BatchCreateUserResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.VerifyAndEnableRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/handler.GenerateCaptchaResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pat.CreateTokenRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/query.GetStatsResult"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "handler.GenerateCaptchaResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "验证码值（开发模式下返回）",
                    "type": "string"
                },
                "expire_at": {
                    "description": "过期时间戳",
        ...
        "handler.VerifyAndEnableRequest": {
            "type": "object",
            "required": [
                "code"
            ],
        ...
        "query.GetStatsResult": {
            ...
            "properties": {
                ...
                "recent_audit_logs": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/query.AuditLogSummaryResult"
                    }
                },
                "total_menus": {
                    "type": "integer"
        ...
        "user.BatchCreateUserResponse": {
            "type": "object",
            "properties": {
                "errors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/user.BatchCreateErrorDetail"
                    }
                },
                "failed": {
                    "type": "integer"
