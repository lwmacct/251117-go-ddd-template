...
func (h *BatchCreateUsersHandler) Handle(ctx context.Context, cmd BatchCreateUsersCommand) (*BatchCreateUserResultDTO, error) {
	result := &BatchCreateUserResultDTO{
		Total:  len(cmd.Users),
...
func (h *BatchCreateUsersHandler) createSingleUser(ctx context.Context, item BatchUserItemDTO) error {
	// 1. 基本验证
...
func (h *BatchCreateUsersHandler) validateUserItem(item BatchUserItemDTO) error {
	// 用户名验证
