...
func NewGetRoleHandler(roleQueryRepo role.QueryRepository) *GetRoleHandler {
...
// Handle 处理获取角色查询
func (h *GetRoleHandler) Handle(ctx context.Context, query GetRoleQuery) (*RoleDTO, error) {
	// 查询角色（包含权限）
