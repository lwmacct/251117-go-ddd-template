...
func getJoinTableIndexes() []database.JoinTableIndex {
	return []database.JoinTableIndex{
		...
		// 组织和团队相关索引
		{Table: "teams", Name: "idx_teams_org_id", Columns: "org_id"},
		{Table: "org_members", Name: "idx_org_members_user_id", Columns: "user_id"},
		{Table: "org_members", Name: "idx_org_members_org_id", Columns: "org_id"},
