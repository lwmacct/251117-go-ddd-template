...
- [页面职责](#页面职责) `:43+6`
- [🎨 布局设计](#布局设计) `:49+45`
  - [注册表单组件 (RegisterForm.vue)](#注册表单组件-registerformvue) `:71+13`
  - [邮箱验证表单组件 (VerifyEmailForm.vue)](#邮箱验证表单组件-verifyemailformvue) `:84+10`
- [🔐 安全特性](#安全特性) `:94+14`
- [📋 类型定义 (types.ts)](#类型定义-typests) `:108+33`
- [状态管理 (composables/useRegister.ts)](#状态管理-composablesuseregisterts) `:141+36`
  - [使用方式](#使用方式) `:167+10`
- [🔄 数据流](#数据流) `:177+38`
- [🎨 UI 组件架构](#ui-组件架构) `:215+32`
  - [注册表单组件 (RegisterForm.vue)](#注册表单组件-registerformvue-1) `:217+20`
  - [邮箱验证表单组件 (VerifyEmailForm.vue)](#邮箱验证表单组件-verifyemailformvue-1) `:237+10`
- [🔄 表单验证](#表单验证) `:247+16`
  - [实时验证](#实时验证) `:249+8`
  - [错误提示](#错误提示) `:257+6`
- [使用流程](#使用流程) `:263+19`
  - [注册流程](#注册流程) `:265+10`
  - [独立访问验证 (从邮件链接)](#独立访问验证-从邮件链接) `:275+7`
- [注意事项](#注意事项) `:282+6`
