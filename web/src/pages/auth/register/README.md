...
- [页面职责](#页面职责) `:41+6`
- [🎨 布局设计](#布局设计) `:47+45`
  - [注册表单组件 (RegisterForm.vue)](#注册表单组件-registerformvue) `:69+13`
  - [邮箱验证表单组件 (VerifyEmailForm.vue)](#邮箱验证表单组件-verifyemailformvue) `:82+10`
- [🔐 安全特性](#安全特性) `:92+14`
- [📋 类型定义 (types.ts)](#类型定义-typests) `:106+33`
- [状态管理 (composables/useRegister.ts)](#状态管理-composablesuseregisterts) `:139+36`
  - [使用方式](#使用方式) `:165+10`
- [🔄 数据流](#数据流) `:175+38`
- [🎨 UI 组件架构](#ui-组件架构) `:213+32`
  - [注册表单组件 (RegisterForm.vue)](#注册表单组件-registerformvue-1) `:215+20`
  - [邮箱验证表单组件 (VerifyEmailForm.vue)](#邮箱验证表单组件-verifyemailformvue-1) `:235+10`
- [🔄 表单验证](#表单验证) `:245+16`
  - [实时验证](#实时验证) `:247+8`
  - [错误提示](#错误提示) `:255+6`
- [使用流程](#使用流程) `:261+19`
  - [注册流程](#注册流程) `:263+10`
  - [独立访问验证 (从邮件链接)](#独立访问验证-从邮件链接) `:273+7`
- [注意事项](#注意事项) `:280+6`
