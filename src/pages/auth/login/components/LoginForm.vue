  ...
  <div class="login-form-wrapper">
    <v-card class="login-card" elevation="0">
        ...
        <v-form @submit.prevent="handleLogin">
          ...
          <div class="mb-4">
            <div class="d-flex align-start gap-3">
              ...
              <!-- 验证码图片 -->
              <div v-if="loginStore.captchaData" class="captcha-image" title="点击刷新验证码" @click="loginStore.fetchCaptcha">
      ...
      <v-card-actions class="justify-center pb-6 flex-column gap-2">
        <v-btn variant="text" prepend-icon="mdi-account-plus" @click="router.push('/auth/register')"> 没有账号？去注册 </v-btn>
      </v-card-actions>
    </v-card>
  </div>
</template>
